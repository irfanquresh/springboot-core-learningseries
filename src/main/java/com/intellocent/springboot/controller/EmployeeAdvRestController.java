...
@RestController
@RequestMapping("/api2")
public class EmployeeAdvRestController {

	private EmployeeService employeeService;

	@Autowired
	public EmployeeAdvRestController(@Qualifier("employeeServiceAdvImpl") EmployeeService theEmployeeService) {
		employeeService = theEmployeeService;
	}

//	@Autowired
//	public EmployeeAdvRestController(EmployeeService theEmployeeService) {
//		employeeService = theEmployeeService;
//	}
